...
namespace CizaCore
{
	public static class AnimatorUtils
	{
		...
		public static void PlayAtStart(this Animator animator, int stateNameHash, int layerIndex = 0)
		{
			animator.Play(stateNameHash, layerIndex, 0);
			animator.Update(0);
		}

		public static async UniTask PlayAtStart(this Animator animator, int stateNameHash, float endNormalizedTime = 1, int layerIndex = 0, CancellationToken cancellationToken = default)
		{
			animator.PlayAtStart(stateNameHash, layerIndex);
			await animator.WaitAnimCompletedByStateNameHash(stateNameHash, endNormalizedTime, cancellationToken);
			animator.SetSpeedRate(0);
		}

		public static async UniTask Play(this Animator animator, int stateNameHash, float endNormalizedTime = 1, int layerIndex = 0, CancellationToken cancellationToken = default)
		{
		...
		public static void Play(this Animator animator, int stateNameHash, float time, ref float duration, int layerIndex = 0)
		{
