...
namespace CizaCore
{
    public static class AnimatorUtils
    {
        ...
        public static async UniTask PlayAtStart(this Animator animator, int stateNameHash, float endNormalizedTime, int layerIndex = 0, CancellationToken cancellationToken = default)
        {
        ...
        public static async UniTask Play(this Animator animator, int stateNameHash, float endNormalizedTime, int layerIndex = 0, CancellationToken cancellationToken = default)
        {
